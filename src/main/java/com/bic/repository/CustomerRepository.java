...
public class CustomerRepository {
    ...
    public boolean isCustomerPresent(int customerId) {
    	return (Long) entityManager
		.createQuery("select count(c.id) from Customer c where c.customerId = :customerId")
...
//   }
   ...
   public void modifyCustomer(Customer customer) {
       ...
       // create update
       CriteriaUpdate<Customer> update = cb.
       ...
       //update.where(cb.greaterThanOrEqualTo(e.get("customerId"), customer.getCustomerId()));
